	...
	<?php } ?>	
		<dl class="article-info">
			<?php if ($canEdit ||  $params->get('show_print_icon') || $params->get('show_email_icon')) { ?>
				...
				<dd class="rstpl-print-article rstpl-clear-right"><span class="print-icon"> <?php echo RSTemplateHelper::addOptiontext(JHtml::_('icon.print_popup', $this->item, $params),JText::_('JGLOBAL_PRINT'),'icon-printer'); ?></span> </dd>
				<?php } ?>
